...
public class ReadBookScreenMod extends Screen {
   ...
   public ReadBookScreenMod.IBookInfo bookInfo;
   public int currPage;
   /** Holds a copy of the page text, split into page width lines */
   public List<ITextComponent> cachedPageLines = Collections.emptyList();
   ...
   public ReadBookScreenMod(ReadBookScreenMod.IBookInfo bookInfoIn, boolean pageTurnSoundsIn) {
   ...
   public int func_214156_a(String p_214156_1_) {
   ...
   public static class UnwrittenBookInfo implements ReadBookScreenMod.IBookInfo {
      ...
      public static List<String> func_216919_b(ItemStack p_216919_0_) {
   ...
   public static class WrittenBookInfo implements ReadBookScreenMod.IBookInfo {
      ...
      public static List<String> func_216921_b(ItemStack stack) {
