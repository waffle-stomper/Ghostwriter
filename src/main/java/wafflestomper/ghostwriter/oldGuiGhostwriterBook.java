...
//
//
//public class GuiGhostwriterBook extends Screen
//{	
//    private static final Logger logger = LogManager.getLogger();
//    private static final ResourceLocation BOOK_GUI_TEXTURES = new ResourceLocation("textures/gui/book.png");
//    private static KeyboardListener keyboardListener;
//    /** The player editing the book */
//    private final ClientPlayerEntity editingPlayer;
...
//    private ListNBT bookPages; // Was NBTTagList
...
//	private Button buttonViewAsSignedUnsigned;
//	
//	private Button buttonBlack;
//	private Button buttonDarkBlue;
//	private Button buttonDarkGreen;
//	private Button buttonDarkAqua;
//	private Button buttonDarkRed;
//	private Button buttonDarkPurple;
...
//	private Button buttonLightPurple;
//	private Button buttonYellow;
//	private Button buttonWhite;
//	private Button buttonObfuscated;
//	private Button buttonBold;
//	private Button buttonStrikethrough;
//	private Button buttonUnderline;
//	private Button buttonItalic;
//	private Button buttonResetFormat;
//	
//
...
//            this.buttonList.add(this.buttonSign = new Button(BTN_SIGN, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.signButton", new Object[0])));
//            this.buttonList.add(this.buttonDone = new Button(BTN_DONE, this.width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.format("gui.done", new Object[0])));
//            this.buttonList.add(this.buttonFinalize = new Button(BTN_FINALIZE, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.finalizeButton", new Object[0])));
//            this.buttonList.add(this.buttonCancel = new Button(BTN_CANCEL, this.width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.format("gui.cancel", new Object[0])));
//            */
//            this.buttonList.add(this.buttonSign = new Button(BTN_SIGN, 5, 115, buttonWidth, buttonHeight, I18n.format("book.signButton", new Object[0])));
//            this.buttonList.add(this.buttonDone = new Button(BTN_DONE, 5, 135, buttonWidth, buttonHeight, I18n.format("gui.done", new Object[0])));
//            this.buttonList.add(this.buttonFinalize = new Button(BTN_FINALIZE, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.finalizeButton", new Object[0])));
//            this.buttonList.add(this.buttonCancel = new Button(BTN_CANCEL, this.width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.format("gui.cancel", new Object[0])));
//            
//            this.buttonList.add(this.buttonViewAsSignedUnsigned = new Button(BTN_VIEW_AS_SIGNED_UNSIGNED, 5, 170, buttonWidth, buttonHeight, "View As Unsigned"));
//        
//            this.buttonList.add(this.buttonPasteBook = new Button(BTN_PASTE_BOOK, rightXPos, 25, buttonWidth, buttonHeight, "Paste Book"));
//      		this.buttonList.add(this.buttonPasteMultiplePages = new Button(BTN_PASTE_MULTIPLE_PAGES, rightXPos, 130, buttonWidth, buttonHeight, "Paste Page"));
//      		this.buttonList.add(this.buttonLoadBook = new Button(BTN_LOAD_BOOK, 5, 25, buttonWidth, buttonHeight, "Load Book"));
//      		this.buttonList.add(this.buttonAutoReloadBook = new Button(BTN_AUTO_RELOAD_BOOK, 5, 45, buttonWidth, buttonHeight, "AutoReload Book"));
//      		this.buttonList.add(this.buttonInsertPage = new Button(BTN_INSERT_PAGE, rightXPos, 155, buttonWidth, buttonHeight, "Insert Blank Page"));
//      		this.buttonList.add(this.buttonCollapseTop = new Button(BTN_COLLAPSE_TOP, rightXPos, 175, buttonWidth, buttonHeight, "Remove Top Space"));
//      		this.buttonList.add(this.buttonAddSignaturePages = new Button(BTN_ADD_SIGNATURE_PAGES, 5, 80, buttonWidth, buttonHeight, "Add Signature Pages"));
//
//      		
//            //The horror...
//            int colorButY = this.height - 40;
//            int formatButY = this.height - 20;
//            this.buttonList.add(this.buttonBlack = new Button(BTN_BLACK, getColorButX(BTN_BLACK), colorButY, 20, 20, "\u00a70A"));
//            this.buttonList.add(this.buttonDarkBlue = new Button(BTN_DARK_BLUE, getColorButX(BTN_DARK_BLUE), colorButY, 20, 20, "\u00a71A"));
//            this.buttonList.add(this.buttonDarkGreen = new Button(BTN_DARK_GREEN, getColorButX(BTN_DARK_GREEN), colorButY, 20, 20, "\u00a72A"));
//            this.buttonList.add(this.buttonDarkAqua = new Button(BTN_DARK_AQUA, getColorButX(BTN_DARK_AQUA), colorButY, 20, 20, "\u00a73A"));
//            this.buttonList.add(this.buttonDarkRed = new Button(BTN_DARK_RED, getColorButX(BTN_DARK_RED), colorButY, 20, 20, "\u00a74A"));
//            this.buttonList.add(this.buttonDarkPurple = new Button(BTN_DARK_PURPLE, getColorButX(BTN_DARK_PURPLE), colorButY, 20, 20, "\u00a75A"));
//            this.buttonList.add(this.buttonGold = new Button(BTN_GOLD, getColorButX(BTN_GOLD), colorButY, 20, 20, "\u00a76A"));
//            this.buttonList.add(this.buttonGray = new Button(BTN_GRAY, getColorButX(BTN_GRAY), colorButY, 20, 20, "\u00a77A"));
//            this.buttonList.add(this.buttonDarkGray = new Button(BTN_DARK_GRAY, getColorButX(BTN_DARK_GRAY), colorButY, 20, 20, "\u00a78A"));
//            this.buttonList.add(this.buttonBlue = new Button(BTN_BLUE, getColorButX(BTN_BLUE), colorButY, 20, 20, "\u00a79A"));
//            this.buttonList.add(this.buttonGreen = new Button(BTN_GREEN, getColorButX(BTN_GREEN), colorButY, 20, 20, "\u00a7aA"));
//            this.buttonList.add(this.buttonAqua = new Button(BTN_AQUA, getColorButX(BTN_AQUA), colorButY, 20, 20, "\u00a7bA"));
//            this.buttonList.add(this.buttonRed = new Button(BTN_RED, getColorButX(BTN_RED), colorButY, 20, 20, "\u00a7cA"));
//            this.buttonList.add(this.buttonLightPurple = new Button(BTN_LIGHT_PURPLE, getColorButX(BTN_LIGHT_PURPLE), colorButY, 20, 20, "\u00a7dA"));
//            this.buttonList.add(this.buttonYellow = new Button(BTN_YELLOW, getColorButX(BTN_YELLOW), colorButY, 20, 20, "\u00a7eA"));
//            this.buttonList.add(this.buttonWhite = new Button(BTN_WHITE, getColorButX(BTN_WHITE), colorButY, 20, 20, "\u00a7fA"));
//            this.buttonList.add(this.buttonObfuscated = new Button(BTN_OBFUSCATED, getFormatButX(BTN_OBFUSCATED), formatButY, 20, 20, "#"));
//            this.buttonList.add(this.buttonBold = new Button(BTN_BOLD, getFormatButX(BTN_BOLD), formatButY, 20, 20, "\u00a7lB"));
//            this.buttonList.add(this.buttonStrikethrough = new Button(BTN_STRIKETHROUGH, getFormatButX(BTN_STRIKETHROUGH), formatButY, 20, 20, "\u00a7mS"));
//            this.buttonList.add(this.buttonUnderline = new Button(BTN_UNDERLINE, getFormatButX(BTN_UNDERLINE), formatButY, 20, 20, "\u00a7nU"));
//            this.buttonList.add(this.buttonItalic = new Button(BTN_ITALIC, getFormatButX(BTN_ITALIC), formatButY, 20, 20, "\u00a7oI"));
//            this.buttonList.add(this.buttonResetFormat = new Button(BTN_RESET_FORMAT, getFormatButX(BTN_RESET_FORMAT), formatButY, 100, 20, "Reset Formatting"));
//        }
//        else{
//            this.buttonList.add(this.buttonDone = new Button(BTN_DONE, this.width / 2 - 100, 4 + this.bookImageHeight, 200, 20, I18n.format("gui.done", new Object[0])));
//        }
//        
//        
//        //Buttons on the left side
//  		this.buttonList.add(this.buttonSaveBook = new Button(BTN_SAVE_BOOK, 5, 5, buttonWidth, buttonHeight, "Save Book"));
//  		
//  		//Buttons on the right side
//  		this.buttonList.add(this.buttonCopyBook = new Button(BTN_COPY_BOOK, rightXPos, 5, buttonWidth, buttonHeight, "Copy Book"));
//  		this.buttonList.add(this.buttonSelectPageA = new Button(BTN_SELECT_PAGE_A, rightXPos, 50, buttonWidth/2, buttonHeight, "A"));
//  		this.buttonList.add(this.buttonSelectPageB = new Button(BTN_SELECT_PAGE_B, rightXPos+buttonWidth/2, 50, buttonWidth/2, buttonHeight, "B"));
//  		this.buttonList.add(this.buttonCopySelectedPages = new Button(BTN_COPY_SELECTED_PAGES, rightXPos, 70, buttonWidth, buttonHeight, "Copy This Page"));
//
//  		this.buttonList.add(this.buttonCutMultiplePages = new Button(BTN_CUT_MULTIPLE_PAGES, rightXPos, 90, buttonWidth, buttonHeight, "Cut This Page"));
//  		this.buttonList.add(this.buttonRemoveSelectedPages = new Button(BTN_REMOVE_SELECTED_PAGES, rightXPos, 110, buttonWidth, buttonHeight, "Remove This Page"));  		
//
...
//    
//
//    protected void actionPerformed(Button buttonPressed){
...
//            default:
//                switch (keycode){
//                    case keyboardListener.KEY_BACK: //Backspace
...
//                        return;
//                        
//                    case keyboardListener.KEY_RETURN:      //Enter
//                    case keyboardListener.KEY_NUMPADENTER: //Numpad enter
//                        this.addTextToPage("\n");
//                        return;
//                        
//                    default:
